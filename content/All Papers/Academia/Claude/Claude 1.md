...
- G0 = Baseline grace (constant divine presence)
- Rp = Repentance factor (turning from sin + confession)
...
- α2 + β2 = 1 (probability normalization)
...
- U0 = Baseline mystery/transcendence
