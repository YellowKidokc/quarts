...
**Princeton Engineering Anomalies Research (PEAR)**: 2.5 million trials (1979-2007) documented 6.35σ deviation from chance in human consciousness effects on quantum random event generators (p < 10−10).

**Global Consciousness Project (GCP)**: Analysis of 345 major events (1998-2019) reveals significant quantum correlations during worldwide focused attention (combined p ≈ 10−9).
