...
∇2Ψ + (2m/ħ2)[E - V(r)]Ψ = iħ(∂Ψ/∂t)

This master equation unifies quantum mechanics and classical physics through the time-dependent Schrödinger equation.

∇2 represents the Laplacian operator describing spatial variations, Ψ is the wavefunction containing all possible information about a system, m is particle mass, ħ is reduced Planck's constant bridging quantum and classical realms, E represents total energy, V(r) is the position-dependent potential energy, and t is time.
