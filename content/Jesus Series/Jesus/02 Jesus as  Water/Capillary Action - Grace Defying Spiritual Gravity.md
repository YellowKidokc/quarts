...
The curved interface creates pressure differences that drive flow: ΔP = γ(1/R1 + 1/R2), where γ is surface tension and R1, R2 are radii of curvature.
...
*Cross-references: [[Surface Tension and Spiritual Integrity]], [[Adhesion Forces in Divine Relationship]], [[Wicking Action in Spiritual Communities]]*