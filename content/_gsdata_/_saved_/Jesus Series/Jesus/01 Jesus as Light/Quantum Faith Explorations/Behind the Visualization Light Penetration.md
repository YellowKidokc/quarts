...
**Mathematics**: The evanescent field decays exponentially with distance: I = I0e^(-αz), but it is never completely zero, showing that light's influence extends beyond visible boundaries.
