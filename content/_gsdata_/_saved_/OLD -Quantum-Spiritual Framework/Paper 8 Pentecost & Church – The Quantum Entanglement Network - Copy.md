...
- **Mathematical Representation:**
    ...
    ∣ΨAB⟩=12(∣0⟩A∣1⟩B+∣1⟩A∣0⟩B)|\Psi_{AB}\rangle = \frac{1}{\sqrt{2}}\Bigl(|0\rangle_A|1\rangle_B + |1\rangle_A|0\rangle_B\Bigr)∣ΨAB⟩=21(∣0⟩A∣1⟩B+∣1⟩A∣0⟩B)
...
R(F,L)=1+∑i=1nFi⋅Li⋅e−diR(F, L) = 1 + \sum_{i=1}^{n} F_i \cdot L_i \cdot e^{-d_i}R(F,L)=1+i=1∑nFi⋅Li⋅e−di
