...
$Ptunnel≈e−2d2m(V−E)ħP_{\text{tunnel}} \approx e^{-2d\sqrt{\frac{2m(V-E)}{\hbar}}}Ptunnel≈e−2dħ2m(V−E)$
...
- **ħ\hbarħ:** The reduced Planck constant.
...
$ΔSresurrection=−λ RJ t\Delta S_{\text{resurrection}} = -\lambda \, R_J \, tΔSresurrection=−λRJt$
